        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-gray-100">
          {submitted ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-8">Your message has been sent successfully.</p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className={`inline-flex items-center justify-center px-8 py-3 text-base font-medium rounded-xl text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 transition-all duration-300 ${
                    isSubmitting ? 'opacity-75 cursor-not-allowed' : 'hover:-translate-y-0.5 hover:shadow-lg'
                  }`}
                >
                  {isSubmitting ? (
                    <>
