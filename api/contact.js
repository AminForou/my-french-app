  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: linear-gradient(135deg, #2563eb, #34d399); 
                    padding: 30px 20px; 
        ...
        <!-- Main content with subtle blue background -->
        ...
        <!-- Footer -->
        <div style="text-align: center; padding: 20px; background: white; border-radius: 0 0 16px 16px;">
